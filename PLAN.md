...
- [ ] **Step 12: JavaScript — navbar scroll effect**
  - Add `scrolled` class to navbar after 60px scroll → triggers frosted glass style

- [ ] **Step 13: JavaScript — scroll animations**
...
- [ ] **Step 14: Responsive design pass**
...
- [ ] **Step 16: Wire up Formspree (waitlist form)**
  ...
  - Set `action="https://formspree.io/f/YOUR_ID"` on the CTA form
...
- [ ] **Step 17: Wire up Calendly (discovery call)**
  ...
  - Replace the `[Book a call]` href with your Calendly link
...
- [ ] **Step 19: Meta + SEO**
  ...
  - This controls how the link looks when shared on Twitter, iMessage, LinkedIn
